...
//  mbmishu
//18101008
  #define direction_Leftmotor1_F 4 //for motor 1 forward
  #define direction_Leftmotor1_B 5 //for motor 1  backward
  #define direction_Rightmotor2_F 6  //for motor 2  forward
  #define direction_Rightmotor2_B 7//for motor 2  backward
 
  #define enableA 3 //speed control for left motor1
  #define enableB 9 //speed control for right motor2
